...
let audioBird = birdsData[1][randomNum]['audio'];
let nameBird = birdsData[1][randomNum]['name'];
...
function writeBirdDescription(event) {
  ...
  let arrBirdNames = document.querySelectorAll('.list__bird-audio__item');
    ...
    for (let i = 0; i < arrBirdNames.length; i++) {
        if (currentElem.innerText == 'Воробей') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[1][0]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  ...
                  <p class="bird__desc-media-species">
                    ${birdsData[1][0]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[1][0]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[1][0]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Грач') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[1][1]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[1][1]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[1][1]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[1][1]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[1][1]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Галка') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[1][2]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[1][2]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[1][2]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[1][2]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[1][2]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Певчий дрозд') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[1][3]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[1][3]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[1][3]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[1][3]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[1][3]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Сорока') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[1][4]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[1][4]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[1][4]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[1][4]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[1][4]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Сойка') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[1][5]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[1][5]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[1][5]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[1][5]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[1][5]["description"]}
              </div>
            </div>
            `
            break;
...
function defineTrueAnswer(event) {
  ...
  if (currentElem.innerText == nameBird) {
    ...
    imgBirdFromSection.src = birdsData[1][currentNum]['image'];
    currentElem.classList.add('style__true-answer');
    buttonNext.classList.add('style__btn-next');
    buttonNext.href = "../../penguin-one/pages/forestbirds.html";
