...
let audioBird = birdsData[3][randomNum]['audio'];
let nameBird = birdsData[3][randomNum]['name'];
...
function writeBirdDescription(event) {
  ...
  let arrBirdNames = document.querySelectorAll('.list__bird-audio__item');
    ...
    for (let i = 0; i < arrBirdNames.length; i++) {
        if (currentElem.innerText == 'Жаворонок') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[3][0]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  ...
                  <p class="bird__desc-media-species">
                    ${birdsData[3][0]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[3][0]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[3][0]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Соловей') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[3][1]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[3][1]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[3][1]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[3][1]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[3][1]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Скворец') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[3][2]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[3][2]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[3][2]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[3][2]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[3][2]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Иволга') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[3][3]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[3][3]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[3][3]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[3][3]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[3][3]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Свиристель') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[3][4]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[3][4]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[3][4]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[3][4]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[3][4]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Щегол') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[3][5]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[3][5]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[3][5]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[3][5]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[3][5]["description"]}
              </div>
            </div>
            `
            break;
...
function defineTrueAnswer(event) {
  ...
  if (currentElem.innerText == nameBird) {
    ...
    imgBirdFromSection.src = birdsData[3][currentNum]['image'];
    currentElem.classList.add('style__true-answer');
    buttonNext.classList.add('style__btn-next');
    buttonNext.href = "../../penguin-one/pages/predatorbirds.html";
