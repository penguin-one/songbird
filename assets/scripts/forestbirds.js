...
let audioBird = birdsData[2][randomNum]['audio'];
let nameBird = birdsData[2][randomNum]['name'];
...
function writeBirdDescription(event) {
  ...
  let arrBirdNames = document.querySelectorAll('.list__bird-audio__item');
    ...
    for (let i = 0; i < arrBirdNames.length; i++) {
        if (currentElem.innerText == 'Зяблик') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[2][0]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  ...
                  <p class="bird__desc-media-species">
                    ${birdsData[2][0]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[2][0]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[2][0]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Клёст') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[2][1]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[2][1]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[2][1]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[2][1]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[2][1]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Горлица') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[2][2]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[2][2]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[2][2]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[2][2]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[2][2]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Дятел') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[2][3]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[2][3]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[2][3]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[2][3]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[2][3]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Удод') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[2][4]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[2][4]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[2][4]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[2][4]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[2][4]["description"]}
              </div>
            </div>
            `
            break;
        } else if (currentElem.innerText == 'Стриж') {
            birdDesc.innerHTML = `
            <div class="bird__desc">
              <div class="bird__desc-media">
                <img src="${birdsData[2][5]["image"]}" alt="a bird" class="bird__desc-media-img">
                <div class="bird__desc-media-audio">
                  <p class="bird__desc-media-name">
                    ${birdsData[2][5]["name"]}
                  </p>
                  <hr class="hr">
                  <p class="bird__desc-media-species">
                    ${birdsData[2][5]["species"]}
                  </p>
                  <hr class="hr">
                  <audio controls><source src="${birdsData[2][5]["audio"]}" type="audio/mpeg"></audio>
                </div>
              </div>
              <div class="bird__desc-text">
                ${birdsData[2][5]["description"]}
              </div>
            </div>
            `
            break;
...
function defineTrueAnswer(event) {
  ...
  if (currentElem.innerText == nameBird) {
    ...
    imgBirdFromSection.src = birdsData[2][currentNum]['image'];
    currentElem.classList.add('style__true-answer');
    buttonNext.classList.add('style__btn-next');
    buttonNext.href = "../../penguin-one/pages/songbirds.html";
